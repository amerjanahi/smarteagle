...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hayy — Community Management" },
      { name: "description", content: "A unified community portal for residents and building admins." },
      { name: "author", content: "Hayy" },
      { property: "og:title", content: "Hayy — Community Management" },
